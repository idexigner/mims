...
|
*/
$config['base_url'] = 'https://mimsbangladesh.com/';
//$config['base_url'] = 'http://localhost/amalesh-shahin/';
...
require_once ('constants/mims-ebooks.php');
require_once ('constants/mims-learning.php');
