...
<head>
    ...
    <!--Core CSS -->
    <link href="<?php echo base_url().'application/views/';?>bs3/css/bootstrap.min.css" rel="stylesheet">
  ...
  <body class="login-body">
    ...
    <script src="<?php echo base_url().'application/views/';?>bs3/js/bootstrap.min.js"></script>
