...
<script>
    var drugObject = {
            ...
            mimsServerAPI.getServerData('GET', formURL, 'jsonp', 'drugObject.getJobCirculars', function(jobData) {
                if (jobData) {
                    ...
                    for (var job_no = 0; job_no < jobData1.length; job_no++) {
                        new_tag_html = jobData1[job_no].NumberOfDatePublished < 4 ? '<img src="<?php echo base_url('application/views/images/new-tag.png');?>" style="max-width: 37px" alt="">' : '';
                        var logo_path = jobData1[job_no].OrganizationLogo == '' || jobData1[job_no].OrganizationLogo == null ? '' : '<?php echo base_url();?>'+'JobImages/'+jobData1[job_no].OrganizationLogo;
                        individual_job = '<div class="row job">' +
                            ...
                            '</div>'+
                            '<div class="col-10">'+
                            '<p class="job-title"><a href="<?php echo site_url('Job/showJobDetail?JobID=')?>'+jobData1[job_no].ID+'">'+jobData1[job_no].Title+new_tag_html+'</a></p>'+
                    ...
                    for (var job_no = 0; job_no < jobData2.length; job_no++) {
                        new_tag_html = jobData2[job_no].NumberOfDatePublished < 4 ? '<img src="<?php echo base_url('application/views/images/new-tag.png');?>" style="max-width: 37px" alt="">' : '';
                        var logo_path = jobData2[job_no].OrganizationLogo == '' || jobData2[job_no].OrganizationLogo == null ? '' : '<?php echo base_url();?>'+'JobImages/'+jobData2[job_no].OrganizationLogo;
                        individual_job = '<div class="row job">' +
                            '<div class="col-2">' +
                            '<img class="job-img" src="'+logo_path+'" alt="" onerror="this.src=\'https://image.ibb.co/cBMMNq/default-placeholder.png\'">'+
                            '</div>'+
                            '<div class="col-10">'+
                            '<p class="job-title"><a href="<?php echo site_url('Job/showJobDetail?JobID=')?>'+jobData2[job_no].ID+'">'+jobData2[job_no].Title+new_tag_html+'</a></p>'+
                ...
                if (specialReportData) {
                    ...
                    for (var special_report_no = 0; special_report_no < specialReportData.length; special_report_no++) {
                        ...
                        individual_special_report = '<div class="home-special-report-slide">' +
                            ...
                            '<p class="home-special-report-slide-title"><a href="<?php echo site_url('SpecialReports/showIndividualSpecialReportDetail?SpecialReportID=');?>'+specialReportData[special_report_no].ID+'">'+special_report_title+'</p>'+
                            '</div>';
        ...
        getMimsStudy: function() {
            ...
            var formURL = "<?php echo site_url('MimsStudy/getMimsStudyForHomePage')?>";
                ...
                if (specialReportData) {
                    ...
                    for (var mims_study_no = 0; mims_study_no < specialReportData.length; mims_study_no++) {
                        ...
                        individual_special_report = '<div class="home-mims-study-slide">' +
                            '<img src="<?php echo base_url();?>MimsStudyImages/'+specialReportData[mims_study_no].ImagePath+'"  alt="" onerror="this.src=\'https://image.ibb.co/cBMMNq/default-placeholder.png\'">'+
                            '<p class="home-mims-study-slide-title"><a href="<?php echo site_url('MimsStudy/showIndividualMimsStudyDetail?MimsStudyID=');?>'+specialReportData[mims_study_no].ID+'">'+mims_study_title+'</p>'+
                            '</div>';
        ...
        getMimsLearning: function() {
            ...
            var formURL = "<?php echo site_url('MiMSLearning/getMiMSLearningForHomePage')?>";
                ...
                if (learningData) {
                    ...
                    for (var mimslearning_no = 0; mimslearning_no < learningData.length; mimslearning_no++) {
                        ...
                        if (learningData[mimslearning_no].MiMSLearningType == 'pdf') {
							individual_learning = '<a class="mimslearning row d-flex align-items-center" target="_blank" href="<?php echo site_url('MiMSLearning/getMiMSLearningDetail');?>?MiMSLearningID='+learningData[mimslearning_no].ID+'" style="padding: 0px 0px 0px 20px;"> ' +
								'<div class="mimslearning-icon d-md-flex d-none" style="margin: 10px 0px;"><span><img src="<?php echo base_url();?>application/views/images/icons/mims-learning.png" style="width: 32px; height: 32px;"></span></div>' +
							...
							individual_learning = '<a class="mimslearning row d-flex align-items-center" target="_blank" href="'+learningData[mimslearning_no].MiMSLearningPath+'">' +
								'<div class="mimslearning-icon d-md-flex d-none"><span><img src="<?php echo base_url();?>application/views/images/icons/mims-learning.png" style="width: 32px; height: 32px;"></span></div>' +
								'<div class="mimslearning-info">' +
								'<p class="mimslearning-name">'+mimslearning_title+'</p>' +
								'</div>' +
								'</a>';
        ...
        getManufacturerBrand: function(objectID, searchOption){
            ...
            var formURL = "<?php echo site_url('Brand/getTotalManufacturerBrand?Manufacturer=')?>"+drugObject.searchOptionValue+'&ManufacturerBrandOption='+drugObject.searchManufacturerBrandOption+'&ProductType='+drugObject.productType;
        ...
        getSearchResult: function(pageNo, objectID, optionType, optionValue) {
			...
			var formURL = "<?php echo site_url('Brand/getSearchResult?Type=')?>"+drugObject.searchOptionType+'&Value='+encodeURIComponent(drugObject.searchOptionValue)+'&PageNo='+pageNo+'&ManufacturerBrandOption='+drugObject.searchManufacturerBrandOption+'&ProductType='+drugObject.productType;
            mimsServerAPI.getServerData('GET', formURL, 'jsonp', 'drugObject.getFeatureProducts', function(drugData){
                if (drugData) {
                    switch (drugObject.searchOptionType) {
                        ...
                        case 'generic':
                            ...
                            for(var i = 0; i < drugData.length; i++) {
                                ...
                                $('tbody.generic-list').append('<td><a href="<?php echo site_url('Brand/searchBrandInformation?Type=brand&Value=');?>'+encodeURIComponent(drugData[i].Name)+'&ProductType='+drugObject.productType+'">'+drugData[i].Name+'</a></td>');
                        ...
                        case 'generic_by_alphabetically':
                            ...
                            for(var i = 0; i < drugData.length; i++) {
                                ...
                                $('tbody.generic-alphabetically-list').append('<td><a href="<?php echo site_url('Brand/searchBrandInformation?Type=brand&Value=');?>'+encodeURIComponent(drugData[i].Name)+'&ProductType='+drugObject.productType+'">'+drugData[i].Name+'</a></td>');
                                $('tbody.generic-alphabetically-list').append('<td><a href="<?php echo site_url('Brand/searchBrandInformation?Type=generic&Value=');?>'+encodeURIComponent(drugData[i].GenericName)+'&ProductType='+drugObject.productType+'">'+drugData[i].GenericName+'</a></td>');
                                $('tbody.generic-alphabetically-list').append('<td><a href="<?php echo site_url('Brand/searchBrandInformation?Type=manufacturer&Value=');?>'+encodeURIComponent(drugData[i].ManufacturerName)+'&ProductType='+drugObject.productType+'">'+drugData[i].ManufacturerName+'</a></td>');
                                $('tbody.generic-alphabetically-list').append('</tr>');
                            }
                            break;
                        case 'indication':
                            ...
                            for(var i = 0; i < drugData.length; i++) {
                                ...
                                $('tbody.indication-list').append('<td><a href="<?php echo site_url('Brand/searchBrandInformation?Type=brand&Value=');?>'+encodeURIComponent(drugData[i].Name)+'&ProductType='+drugObject.productType+'">'+drugData[i].Name+'</a></td>');
                                $('tbody.indication-list').append('<td><a href="<?php echo site_url('Brand/searchBrandInformation?Type=generic&Value=');?>'+encodeURIComponent(drugData[i].GenericName)+'&ProductType='+drugObject.productType+'">'+drugData[i].GenericName+'</a></td>');
                                $('tbody.indication-list').append('<td><a href="<?php echo site_url('Brand/searchBrandInformation?Type=manufacturer&Value=');?>'+encodeURIComponent(drugData[i].ManufacturerName)+'&ProductType='+drugObject.productType+'">'+drugData[i].ManufacturerName+'</a></td>');
                                $('tbody.indication-list').append('</tr>');
                            }
                            break;
                        case 'manufacturer':
                            ...
                            for(var i = 0; i < drugData.length; i++) {
                                ...
                                $('tbody.manufacturer-list').append('<td><a href="<?php echo site_url('Brand/searchBrandInformation?Type=brand&Value=');?>'+encodeURIComponent(drugData[i].Name)+'&ProductType='+drugObject.productType+'">'+drugData[i].Name+'</a></td>');
                                $('tbody.manufacturer-list').append('<td><a href="<?php echo site_url('Brand/searchBrandInformation?Type=generic&Value=');?>'+encodeURIComponent(drugData[i].GenericName)+'&ProductType='+drugObject.productType+'">'+drugData[i].GenericName+'</a></td>');
                                $('tbody.manufacturer-list').append('</tr>');
                            }
                            break;
                        default:
        ...
        getNewInformation: function(pageNo) {
            ...
            var formURL = "<?php echo site_url('Brand/getNewInformation?Type=')?>"+drugObject.searchOptionTypeForNewInformation+'&PageNo='+pageNo;
        ...
        searchBrandInformation: function(Option) {
            ...
            var formURL = "<?php echo site_url('Brand/searchBrandInformation?Type=')?>"+drugObject.searchOptionType+'&Value='+drugObject.searchOptionValue+'&ProductType='+drugObject.productType;
            switch (drugObject.searchOptionType) {
                case 'brand':
            ...
            mimsServerAPI.getServerData('GET', formURL, 'jsonp', 'drugObject.getFeatureProducts', function(drugData){
                ...
                if(drugData) {
                    ...
                    for (var i = 0; i < home_page_new_item_limit; i++) {
                        ...
                        $('div.new-product-information').append('<a href="<?php echo site_url('Brand/searchBrandInformation?Type=brand&Value=')?>'+encodeURIComponent(drugData[i].Name)+'&ProductType='+drugObject.productType+'">'+drugData[i].Name+'</a>');
                    }

                    if (i > 0) {
                        $('div.new-product-information').append('<a href="<?php echo site_url('Brand/showNewInformation?Type=new_product')?>">See More</a>');
                    }
                }
            });
        },
            ...
            mimsServerAPI.getServerData('GET', formURL, 'jsonp', 'drugObject.getNewPresentations', function(drugData){
                ...
                if(drugData) {
                    ...
                    for (var i = 0; i < home_page_new_item_limit; i++) {
                        ...
                        $('div.new-presentation-information').append('<a href="<?php echo site_url('Brand/searchBrandInformation?Type=brand&Value=')?>'+encodeURIComponent(drugData[i].Name)+'&ProductType='+drugObject.productType+'">'+drugData[i].Name+'</a>');
                    }

                    if (i > 0) {
                        $('div.new-presentation-information').append('<a href="<?php echo site_url('Brand/showNewInformation?Type=new_presentation')?>">See More</a>');
                    }
                }
            });
        },
            ...
            mimsServerAPI.getServerData('GET', formURL, 'jsonp', 'drugObject.getNewBrands', function(drugData){
                ...
                if(drugData) {
                    ...
                    for (var i = 0; i < home_page_new_item_limit; i++) {
                        ...
                        $('div.new-brand-information').append('<a href="<?php echo site_url('Brand/searchBrandInformation?Type=brand&Value=')?>'+encodeURIComponent(drugData[i].Name)+'&ProductType='+drugObject.productType+'">'+drugData[i].Name+'</a>');
                    }

                    if (i > 0) {
                        $('div.new-brand-information').append('<a href="<?php echo site_url('Brand/showNewInformation?Type=new_brand')?>">See More</a>');
                    }
                }
            });
        },
        ...
        searchAlphabetically: function(value) {
            if(drugObject.searchOptionType == 'manufacturer') {
                ...
                window.location.replace('<?php echo site_url('Brand/searchBrandInformation?Type=');?>'+type+'&Value='+encodeURIComponent(value)+'&ProductType='+drugObject.productType);
            }
        },
        getDrugList: function(getDrugList) {
            ...
            var formURL = "<?php echo site_url('Brand/getAllDrugInformation')?>"+'?PageNo='+pageNo+'&ProductType='+drugObject.productType;
        ...
        getAllDrugInfoForAutoComplete: function(searchOption) {
			...
			var formURL = "<?php echo site_url('Brand/getAllDrugInfoForAutoComplete')?>"+'?ProductType='+drugObject.productType;
