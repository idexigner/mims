                ...
                <div class="brand-indication-table brand-of-generic">
                    <table class="table">
                        ...
                        foreach ($AllIndications AS $brand) {
                            echo '<tr>';
                            echo '<td><a href="'.site_url('Brand/searchBrandInformation?Type=generic&ProductType=1&Value='.urlencode($brand['Name'])).'">'.$brand['Name'].'</a></td>';
                            echo '</tr>';
                        }
                        ?>
                        </tbody>
...
<script>
    ...
    drugObject.searchObjectID = 'search-indication-pagination';
    ...
    frontendCommonMethods.getCategoryWiseAdvertisement(3, drugObject.searchOptionValue, ['indication-sidebar-advert', 'indication-advert-top-left', 'indication-advert-top-right', 'indication-advert-bottom']);
</script>
