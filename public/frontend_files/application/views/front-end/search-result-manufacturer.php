...
<script>
    ...
    frontendCommonMethods.getCommonAdvertisement(['manufacturer-sidebar-advert', 'manufacturer-advert-top-left', 'manufacturer-advert-top-right', 'manufacturer-advert-bottom']);
