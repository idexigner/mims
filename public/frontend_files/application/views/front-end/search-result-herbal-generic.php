                ...
                <div class="brand-details">
                    ...
                    <div class="brand-info-table">
                        <table class="table">
                            ...
                            <?php if(!empty($GenericData[0]['Classification'])) {
                                ?>
                                <tr>
                            ...
                            <?php if(!empty($GenericData[0]['SafetyRemark'])) {
                                ?>
                                <tr>
                    ...
                    <div class="brand-description">
                        <?php if(!empty($GenericData[0]['Indication'])) {
                            ?>
                        ...
                        <?php if(!empty($GenericData[0]['DosageAdministration'])) {
                            ?>
                            <div class="brand-description-point">
						...
						<?php if(!empty($GenericData[0]['ContraindicationPrecaution'])) {
							?>
							<div class="brand-description-point">
						...
						<?php if(!empty($GenericData[0]['Composition'])) {
							?>
							<div class="brand-description-point">
								<p class="brand-description-title">Composition</p>
								<p class="brand-description-text"><?php echo $GenericData[0]['Composition'];?></p>
							</div>
							<?php
						} ?>
						<?php if(!empty($GenericData[0]['Pharmacology'])) {
							?>
							<div class="brand-description-point">
								<p class="brand-description-title">Pharmacology</p>
								<p class="brand-description-text"><?php echo $GenericData[0]['Pharmacology'];?></p>
							</div>
							<?php
						} ?>
						<?php if(!empty($GenericData[0]['Interaction'])) {
							?>
							<div class="brand-description-point">
								<p class="brand-description-title">Interaction</p>
								<p class="brand-description-text"><?php echo $GenericData[0]['Interaction'];?></p>
							</div>
							<?php
						} ?>
						<?php if(!empty($GenericData[0]['SideEffect'])) {
                            ?>
                            <div class="brand-description-point">
						...
						<?php if(!empty($GenericData[0]['OverdoseEffect'])) {
							?>
							<div class="brand-description-point">
								<p class="brand-description-title">Overdose Effect</p>
								<p class="brand-description-text"><?php echo $GenericData[0]['OverdoseEffect'];?></p>
							</div>
							<?php
						} ?>
						<?php if(!empty($GenericData[0]['StorageCondition'])) {
							?>
							<div class="brand-description-point">
								<p class="brand-description-title">Storage Condition</p>
								<p class="brand-description-text"><?php echo $GenericData[0]['StorageCondition'];?></p>
							</div>
							<?php
						} ?>
						<?php if(!empty($GenericData[0]['PregnancyLactation'])) {
                            ?>
                            <div class="brand-description-point">
                ...
                <div class="brand-generic-table brand-of-generic">
                    <table class="table">
                        ...
                        foreach ($BrandData AS $brand) {
                            echo '<tr>';
                            echo '<td><a href="'.site_url('Brand/searchBrandInformation?Type=brand&ProductType=2&Value='.urlencode($brand['Name'])).'">'.$brand['Name'].'</a></td>';
                            echo '<td><a href="'.site_url('Brand/searchBrandInformation?Type=manufacturer&ProductType=2&Value='.urlencode($brand['ManufacturerName'])).'">'.$brand['ManufacturerName'].'</a></td>';
                            echo '</tr>';
                        }
                        ?>
                        </tbody>
...
<script>
    ...
    drugObject.searchObjectID = 'search-generic-pagination';
