							...
							<div class="brand-info-table">
								<table class="table">
									...
									<tr>
										...
										<td style="color: blue">: <a href="<?php echo site_url('Brand/searchBrandInformation?Type=generic&ProductType=2&Value='.urlencode($AllBrands[0]['GenericName']));?>"><?php echo $AllBrands[0]['GenericName'];?></a></td>
									</tr>
									<tr>
										<td class="brand-info-title">Manufacturer Name</td>
										<td style="color: blue">: <a href="<?php echo site_url('Brand/searchBrandInformation?Type=manufacturer&ProductType=2&Value='.urlencode($AllBrands[0]['ManufacturerName']))?>"><?php echo $AllBrands[0]['ManufacturerName'];?></a></td>
									</tr>
					...
					<div class="form-group">
						<div class="col-12">
							<div class="brand-description">
								...
								<?php if(!empty($AllBrands[0]['Composition'])) {
									?>
									<div class="brand-description-point">
										<p class="brand-description-title">Composition</p>
										<p class="brand-description-text"><?php echo $AllBrands[0]['Composition'];?></p>
									</div>
									<?php
								} ?>
								<?php if(!empty($AllBrands[0]['Pharmacology'])) {
									?>
									<div class="brand-description-point">
										<p class="brand-description-title">Pharmacology</p>
										<p class="brand-description-text"><?php echo $AllBrands[0]['Pharmacology'];?></p>
									</div>
									<?php
								} ?>
								<?php if(!empty($AllBrands[0]['Interaction'])) {
									?>
									<div class="brand-description-point">
										<p class="brand-description-title">Interaction</p>
										<p class="brand-description-text"><?php echo $AllBrands[0]['Interaction'];?></p>
									</div>
									<?php
								} ?>
								...
								<?php if(!empty($AllBrands[0]['OverdoseEffect'])) {
									?>
									<div class="brand-description-point">
										<p class="brand-description-title">Overdose Effect</p>
										<p class="brand-description-text"><?php echo $AllBrands[0]['OverdoseEffect'];?></p>
									</div>
									<?php
								} ?>
								<?php if(!empty($AllBrands[0]['StorageCondition'])) {
									?>
									<div class="brand-description-point">
										<p class="brand-description-title">Storage Condition</p>
										<p class="brand-description-text"><?php echo $AllBrands[0]['StorageCondition'];?></p>
									</div>
									<?php
								} ?>
