                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="color: blue">: <a href="<?php echo site_url('Brand/searchBrandInformation?Type=generic&ProductType=1&Value=' . urlencode($BrandDetail['GenericName'])); ?>"><?php echo $BrandDetail['GenericName']; ?></a></td>
                                        </tr>
                                        <tr>
                                            <td class="brand-info-title">Manufacturer Name</td>
                                            <td style="color: blue">: <a href="<?php echo site_url('Brand/searchBrandInformation?Type=manufacturer&ProductType=1&Value=' . urlencode($BrandDetail['ManufacturerName'])) ?>"><?php echo $BrandDetail['ManufacturerName']; ?></a></td>
                                        </tr>
                                        <tr>
...
<script>
    ...
    frontendCommonMethods.getCategoryWiseAdvertisementForSlider(2, <?php echo $BrandDetail['ID']; ?>, ['brand-advert-image']);
</script>