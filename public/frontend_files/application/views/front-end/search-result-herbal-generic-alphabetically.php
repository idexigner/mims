                ...
                <div class="brand-generic-table">
                    <table class="table">
                        ...
                        foreach ($BrandData AS $brand) {
                            ...
                            echo '<td><a href="'.site_url('Brand/searchBrandInformation?Type=generic&ProductType=2&Value='.urlencode($brand['GenericName'])).'">'.$brand['GenericName'].'</a></td>';
...
<script>
    ...
    drugObject.searchObjectID = 'search-genetic-pagination';
