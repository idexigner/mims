        ...
        <div class="col-md-8 col-12">
            ...
            <div class="international-health-list news-list container">
                ...
                foreach ($AllInternationalHealth AS $internationalHealth) {
                    if ($InternationalHealthInfo['ID'] == $internationalHealth['ID']) continue;
                    $international_health_description = $internationalHealth['Description'];
//                    $international_health_description = strlen($international_health_description) > 500 ? substr($international_health_description, 0, 116) . ' ...' : $international_health_description;
