...
var data=['generic-advert-bottom','generic-advert-top-left', 'generic-advert-top-right','generic-sidebar-advert'];
        var categoryID=1;
        var categoryValue='<?php echo $OptionValue;?>';
        
        for (let x in data)
        {
            var urllink="<?php echo site_url('CategoryWiseAdvertisement/getAdvertisement?ClassName=') ?>"+ data[x] + '&CategoryID=' + categoryID + '&CategoryValue=' + categoryValue+'&callback'+'=forntravi';
           // alert(urllink);
            $.get(urllink,function(advertisementData){
                advertisementData=JSON.parse(advertisementData).response
               // alert(advertisementData[0].ClassName);
                if (advertisementData[0].ImagePath == undefined)
                {
                    frontendCommonMethods.getCommonAdvertisement([advertisementData[0].ClassName]);
                } else 
                {
                    $('.' + advertisementData[0].ClassName).html('<img src="<?php echo base_url('AdvertisementImages/'); ?>' + advertisementData[0].ImagePath + '" alt="">');
                }
            });
        }
...
// frontendCommonMethods.getCategoryWiseAdvertisement(1, drugObject.searchOptionValue, ['generic-sidebar-advert', 'generic-advert-top-left', 'generic-advert-top-right', 'generic-advert-bottom']);
</script>
