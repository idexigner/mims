    ...
    <section class="content-header">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <button type="button" class="btn float-sm-right btn-primary add_new">Add New Country</button>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <form class="form-horizontal" id="create-form">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Add New Country Record</h4>
                    ...
                    <!-- <form class="form-horizontal"> -->
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Name" name="country_name" required data-parsley-maxlength="200">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <select class="form-control" name="country_is_active">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="submit" data-url="{{ route('setting.country.store') }}" class="btn btn-primary" id="create_form_btn">Create</button>
                    <button type="submit" data-url="{{ route('setting.country.update') }}" class="btn btn-primary" id="update_form_btn">Update</button>
                </div>
            </form>
            </div>
            <!-- /.modal-content -->
...
@push('js-link')
     ...
     <script>
        $(function () {
            ...
            var ajaxUrl = "{{ route('setting.country.index') }}";
            var columnsArray = [                  
                    { data: 'country_name', name: 'country_name', title: 'Country Name', width: '75%'},
                    {
                        data: null,
                        title: 'Action',
                        render: function(data, type, row) {
                            return '<a href="#" class="edit" data-id="'+row.country_id+'"><i class="fas fa-edit text-success"></i></a> <a href="#" class="delete" data-id="'+row.country_id+'"><i class="fas fa-trash text-danger"></i></a>';
                        },
                        orderable: false,
                        searchable: false
                    }
            ...
            $('.add_new').on('click', function(){
                ...
                $("#modal_create_form .modal-title").text("Add New Country Record");
            ...
            table.on('click', '.edit', function() {
                ...
                $("#modal_create_form .modal-title").text("Update Country Form Record");

                var id = $(this).data('id');
                var url = "{{ route('setting.country.edit', ':id') }}";
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("input[name=id]").val(data.country_id);
                        $("input[name=country_name]").val(data.country_name);
                        $("select[name=country_is_active]").val(data.country_is_active);
            ...
            table.on('click', '.delete', function() {
                ...
                Swal.mixin({
                    ...
                    if (result.isConfirmed) {
                        ...
                        var url = "{{ route('setting.country.destroy', ':id') }}";
                        url = url.replace(':id', id);
                        $.ajax({
                            url: url,
                            type: 'DELETE',
                            ...
                            success: function(response) {
                                ...
                                Toast.fire({
                                    icon: 'success',
                                    title: "Country record deleted successfully",
                                    timer: 3000,
                                });
                                // reload the table
                                table.DataTable().ajax.reload();
