...
<script>
    $(document).ready(function() {
        ...
        speicalreportMethods.getSpecialReportDetail({{$id}});
    ...
    var speicalreportMethods = {
        getSpecialReportDetail: function(id) {
            $.ajax({
                url: "{{ url('/')}}/get_special_report_detail/"+id,
                type: 'GET',
                dataType: 'json',
                // data: {
                ...
                success: function(response) {
                    console.log("get_special_report_detail", response);
