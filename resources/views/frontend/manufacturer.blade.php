...
<script>
    $(document).ready(function() {
        ...
        $('.select2').select2()
        getAdvertisements('manufacturer', {{ $manufacturer->manufacturer_id }});
        manufacturerMethods.getHerbal();
    ...
    var manufacturerMethods = {
        getHerbal: function() {

            var table = $('#table-standard');
            var tableName = '#table-standard';
            var ajaxUrl = "{{ route('web_page_manufacturer_detail') }}";
            ...
            var columnsArray = [                  
                    ...
                    // { data: 'manufacturer_name', name: 'manufacturer_name', title: 'Manufac'},
                    {
                        data: null,
                        title: 'Brand Name',
                        render: function(data, type, row) {
                    ...
                    },
                    {
                        ...
                        title: 'Generic Name',
                        render: function(data, type, row) {
                            return '<a href="{{ url('/')}}/generic_detail/'+row.generic.generic_id+'"  >'+row.generic.generic_name+'</a> ';
                        },
                        orderable: false,
                        searchable: false
                    },
