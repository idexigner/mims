        ...
        <div class="col-md-8 col-12">
            <div class="content-section main">
                <div class="brand-details">
                    <div class="row">
                        <div class="col-7">
                            <h2 class="brand-title">ARISCON</h2>
        ...
        getDetail: function(id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#indication_para").text(data.generic.generic_indication);
                    $("#dosage_administration").text(data.generic.generic_dosage_administration);
                    $("#contraindication_precaution").text(data.generic.generic_contraindication_precaution);
                    $("#side_effect").text(data.generic.generic_side_effect);
                    $("#pregnancy_lactation").text(data.generic.generic_pregnancy_lactation);
